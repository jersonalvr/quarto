  ...
  pdf:
    ...
    include-in-header: 
      text: |
        ...
        \newcommand{\footerfont}{\fontsize{9}{11}\selectfont\centurygothic}
        ...
        %-----------------------------------------------------------------
        % Definición del estilo de página para las páginas iniciales (antes del índice)
        \fancypagestyle{pretoc}{
          \fancyhf{}
          \fancyfoot[R]{\footerfont \textbf{icontinental}.edu.pe}
          \fancyhead[C]{%
            \makebox[\textwidth][c]{%
        ...
        % Definición del estilo de página para las páginas posteriores al índice
        \fancypagestyle{posttoc}{
          ...
          \fancyfoot[R]{\footerfont \textbf{icontinental}.edu.pe \,|\, \thepage}
          \renewcommand{\headrulewidth}{0pt}
          \renewcommand{\footrulewidth}{0pt}
        }
        
        % Inicialmente se usa el estilo de página "pretoc"
        \pagestyle{pretoc}
...
# !sudo systemctl start mongod desde usuario hadoop
